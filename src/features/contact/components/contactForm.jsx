...
const ContactForm = () => {
    return (
        ...
        >
            {({ handleSubmit }) => (
                <Form onSubmit={handleSubmit} className="space-y-4 p-4 lg:w-[28rem]">
                    ...
                    <div className="flex justify-center">
                        <button
                            type="submit"
                            className="bg-primary text-white py-2 px-4 w-full rounded-lg hover:bg-primary-dark focus:outline-none"
                        >
                            Submit
                        </button>
                    </div>
